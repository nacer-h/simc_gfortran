...
c      write(6,*) "Enter E, E', theta, current"
 40   read(30,*,end=950) e,epin,theta,bcur            
      ...
      eppass = epin
      thpass = theta*radcon
c luminosity of 1uA on 1g/cm3 protons is 3.758e36 so factor is divided by 10e33
c      lum = 3758.6*bcur*dens*tlength 
c luminosity for 3He target 5e37/cm2/sec
c assume 3He cross section scales as the charge, so X2
      lum = 2.*(5.e4)
